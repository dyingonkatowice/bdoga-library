...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-[#f6f7f2] text-[#1e2922] dark:bg-[#111612] dark:text-[#edf3ea] lg:h-screen lg:overflow-hidden">
      ...
      <main className="min-h-screen lg:h-screen lg:overflow-hidden lg:pl-64"><div className="mx-auto flex min-h-screen max-w-[1440px] flex-col px-4 py-4 sm:px-8 lg:h-full lg:overflow-hidden lg:px-10 lg:py-6">
        <nav className="mb-5 grid grid-cols-4 gap-1 rounded-xl border border-[#dfe5dc] bg-white p-1 text-center text-[11px] font-medium text-[#718073] dark:border-[#29332b] dark:bg-[#171d18] lg:hidden"><Link href="/" className="flex flex-col items-center gap-1 rounded-lg bg-[#e8f2d1] px-1 py-2 text-[#456321] dark:bg-[#26351f] dark:text-[#d9ef63]"><LayoutDashboard size={16} />Genel bakış</Link><Link href="/kitaplar" className="flex flex-col items-center gap-1 rounded-lg px-1 py-2 hover:bg-[#f0f3ec] dark:hover:bg-[#232c24]"><Library size={16} />Kitaplar</Link><Link href="/odunc-islemleri" className="flex flex-col items-center gap-1 rounded-lg px-1 py-2 hover:bg-[#f0f3ec] dark:hover:bg-[#232c24]"><Archive size={16} />Ödünç</Link><Link href="/ayarlar" className="flex flex-col items-center gap-1 rounded-lg px-1 py-2 hover:bg-[#f0f3ec] dark:hover:bg-[#232c24]"><Settings2 size={16} />Ayarlar</Link></nav>
